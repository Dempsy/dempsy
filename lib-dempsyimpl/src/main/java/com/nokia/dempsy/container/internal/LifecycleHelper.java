...
/**
 *  This class holds the MP prototype, and supports invocation of MP methods on
 *  an instance.
 */
public class LifecycleHelper
{
   ...
   private Method activationMethod;
   private Method passivationMethod;
   ...
   public LifecycleHelper(Object prototype) throws ContainerException
   {
      ...
      activationMethod = AnnotatedMethodInvoker.introspectAnnotationSingle(mpClass, Activation.class);
      passivationMethod = AnnotatedMethodInvoker.introspectAnnotationSingle(mpClass, Passivation.class);
    ...
    */
   public void activate(Object instance, byte[] activationData) throws IllegalArgumentException, IllegalAccessException, InvocationTargetException
   {
      if (activationMethod != null)
         activationMethod.invoke(instance, activationData);
   }


   /**
    *  Invokes the passivation method of the passed instance. Will return the
    *  object's passivation data, <code>null</code> if there is none.
   ...
   /**
    *  Invokes the appropriate message handler of the passed instance. Caller
    *  is responsible for not passing <code>null</code> messages.
   ...
   public Object getPrototype() { return prototype; }


   /**
    *  Invokes the output method, if it exists. If the instance does not have an
    *  annotated output method, this is a no-op (this is simpler than requiring
    *  the caller to check every instance).
    * @throws InvocationTargetException 
    * @throws IllegalAccessException 
    * @throws IllegalArgumentException 
    */
   ...
   /**
    *  Determines whether this MP has a handler for the passed message. Will
    *  walk the message's class hierarchy if there is not an exact match.
    */
...
//----------------------------------------------------------------------------
   ...
   private Method introspectClone()
   throws ContainerException
   {
      try
      {
