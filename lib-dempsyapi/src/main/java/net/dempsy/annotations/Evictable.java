...
package net.dempsy.annotations;
 ...
 *  to check if the {@link MessageProcessor} can be evicted. This method should return 
 *  boolean indicating the state of {@link MessageProcessor}.</p>
 *  
 *  <p>Return value of True indicated state of {@link MessageProcessor} as ready
 *  to be evicted and hence the {@link MessageProcessor} should be used to handle
